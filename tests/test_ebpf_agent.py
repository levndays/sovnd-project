...
EBPF_AGENT_FILE = Path(__file__).parent.parent / "src" / "ebpf_agent.py"
...
class TestEBPFAggentModule:
    ...
    def test_event_cb_type_defined(self):
        ...
        import sys
        sys.path.insert(0, str(EBPF_AGENT_FILE.parent))
        from ebpf_agent import EVENT_CB
...
class TestEBPFAggentInit:
    ...
    def mock_cdll(self):
        """Mock ctypes.CDLL."""
        with patch("ebpf_agent.ctypes.CDLL") as mock:
            mock_lib = MagicMock()
    ...
    def test_init_sets_argtypes_for_start_loader(self):
        ...
        with patch("ebpf_agent.ctypes.CDLL") as mock_cdll:
            ...
            import sys
            sys.path.insert(0, str(EBPF_AGENT_FILE.parent))
            from ebpf_agent import EBPFAgent, EVENT_CB
